  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-screen">
        <form onSubmit={signup} className="w-full max-w-md p-4 border rounded shadow-sm">
          <img
          ...
          <div className="mb-3">
            ...
            <small id="usernameHelp" className="text-xs text-gray-500 mt-1">
              <a href="/login" className="text-indigo-600 hover:text-indigo-500">Already have an account? Click here to login.</a>
            </small>
          </div>
